...
function processEnvironmentVariables() {
   ...
   if (Array.isArray(config.contextBroker.jsonLdContext) && config.contextBroker.jsonLdContext.length === 1){
    ...
    config.contextBroker.host="192.168.2.222"
    config.contextBroker.port="1027"
config.mongodb.host="192.168.2.222"
config.server.port="4041"
config.deviceRegistry.type="mongodb"

config.mongodb.host="192.168.2.222"
config.mongodb.port="27017"
config.mongodb.db="iotagentul"
    config.authentication.tokenPath="/oauth2/token"
